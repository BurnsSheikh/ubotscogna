...
async def kill(e):
    ...
    await asyncio.sleep(1.0)
    await asyncio.wait([e.edit("**Bersaglio ucciso 😈**")])
...
async def comandi(e):
 await asyncio.wait([e.edit("[🔗Comandi Userbot](https://telegra.ph/Comandi-Userbot-05-21)")])
  ...
  if verify != None:
    if e.chat_id == 178220800:
      if ":" in e.text:
        ...
        await verify.edit("**✅ Buone notizie! Non sei limitato ✅**")
        verify = None
        await e.client(functions.messages.DeleteHistoryRequest(e.chat_id, 0, False, True))
